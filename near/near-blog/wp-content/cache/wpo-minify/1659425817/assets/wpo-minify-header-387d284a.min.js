...
cssTarget={"Bodhi":"img.style-svg","ForceInlineSVG":"style-svg"};ForceInlineSVGActive="true";jQuery(document).ready(function($){$(".rec-job-info").on("click",function(){var linkjob=$('.rec-job-info').find("a").attr("href");alert(linkjob)})});
